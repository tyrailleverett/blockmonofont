	...
	return (
		<section className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden rounded-md bg-black">
			...
			<div className="z-10 flex items-center gap-4">
				<Button asChild variant="outline" className="text-white hover:text-white">
					<Link href="#try-font">Try Font Now</Link>
				</Button>
				<Button asChild variant="default">
					<Link href="https://github.com/tyrailleverett/block-mono/releases/latest">Download Now</Link>
				</Button>
			</div>
		</section>
	);
